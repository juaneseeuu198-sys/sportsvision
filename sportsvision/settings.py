...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware',   # i18n: detecta idioma del navegador
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'SportsVision <onboarding@resend.dev>')
